var playbuzz_search = function playbuzz_search() {
    ...
    function playbuzz_search_popup_structure(on_select_item) {
        ...
        // Header
        (jQuery)("<div></div>").attr("id", "playbuzz_popup_close").appendTo("#playbuzz_search_header").click(function () {
            (jQuery)(".playbuzz_popup_overlay_container").remove();
        });
        (jQuery)("<div></div>").addClass("playbuzz_search_logo").appendTo("#playbuzz_search_header").click(function () {
            clear_search_info();
            playbuzz_featured_items(1, on_select_item);
        });
        (jQuery)("<span></span>").appendTo(".playbuzz_search_logo").text(translation.playbuzz);
        (jQuery)("<nav></nav>").appendTo("#playbuzz_search_header");
        (jQuery)("<div></div>").attr("id", "playbuzz_popup_tab_content").click(function () {
            clear_search_info();
            playbuzz_featured_items(1, on_select_item);
        }).addClass("playbuzz_active_tab").appendTo("#playbuzz_search_header nav");
        (jQuery)("<div></div>").attr("id", "playbuzz_popup_tab_myitems").click(function () {
            clear_search_info();
        ...
        // Input form
        (jQuery)("<input>").attr("type", "text").attr("id", "playbuzz_search").attr("class", "playbuzz_search").attr("name", "playbuzz_search").attr("size", "16").attr("autocomplete", "off").attr("placeholder", translation.search_term).appendTo("#playbuzz_search_input_form").keyup(function () {
        ...
        (jQuery)("<select></select>").attr("name", "playbuzz_search_type").attr("id", "playbuzz_search_type").addClass("playbuzz_search_type").appendTo(".playbuzz_search_fields").change(function () {
            playbuzz_show_screen(on_select_item);
        });
        ...
        (jQuery)("<select></select>").attr("name", "playbuzz_search_sort").attr("id", "playbuzz_search_sort").addClass("playbuzz_search_sort").appendTo(".playbuzz_search_fields").change(function () {
            playbuzz_show_screen(on_select_item);
        });
